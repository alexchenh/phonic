...
tf.app.flags.DEFINE_boolean('resume', False, 'Whether to restore or not')
tf.app.flags.DEFINE_string('ckpt_path', '../training/baseline/checkpoint/model_epoch10.ckpt', 'Checkpoint path')
